...
.. _The Saga Software Project: https://saga-soft.io
...
.. toctree::
   ...
   The Saga Software Project <https://saga-soft.io>
...
little project, so we spent many coffee and lunch breaks sketching out the features we'd like to
...
In 2026, the project moved from my personal repository on GitHub to `The Saga Software Project`_,
which i set up to make it easier to add more collaborators on the project. Meanwhile, novelWriter
is still under active development, and I personally use it for all my writing projects. This is not
likely to change any time soon. I hope you too find it useful, and my wish is that it will help
writers focus on writing in the future.
