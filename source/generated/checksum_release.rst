...
.. tab-set::
   ...
   .. tab-item:: Linux
      ...
      .. code-block:: bash
         ...
         shasum -c novelwriter-26.1.2-x86_64.AppImage.sha256
         shasum -c novelwriter_26.1.2_all.deb.sha256
   ...
   .. tab-item:: Windows
      ...
      .. code-block:: powershell
         ...
         Get-FileHash -Algorithm SHA256 novelwriter-26.1.2-amd64-setup.exe | Format-List
